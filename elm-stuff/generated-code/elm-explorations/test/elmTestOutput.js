...
var author$project$FizzBuzz$fizzBuzz = function (n) {
	return ((!A2(elm$core$Basics$modBy, 3, n)) && (!A2(elm$core$Basics$modBy, 5, n))) ? 'FizzBuzz' : ((!A2(elm$core$Basics$modBy, 3, n)) ? 'Fizz' : ((!A2(elm$core$Basics$modBy, 5, n)) ? 'Buzz' : elm$core$String$fromInt(n)));
};
		...
		[
			...
			function (_n0) {
				return A2(
					...
					'Fizz',
					author$project$FizzBuzz$fizzBuzz(6));
			}),
			A2(
			elm_explorations$test$Test$test,
			'multiple of 5',
			function (_n1) {
				return A2(
					elm_explorations$test$Expect$equal,
					'Buzz',
					author$project$FizzBuzz$fizzBuzz(10));
			}),
			A2(
			elm_explorations$test$Test$test,
			'multiple of 5 and multiple of 3',
			function (_n2) {
				return A2(
					elm_explorations$test$Expect$equal,
					'FizzBuzz',
					author$project$FizzBuzz$fizzBuzz(15));
			}),
			A2(
			elm_explorations$test$Test$test,
			'not multiple of 5 or multiple of 3',
			function (_n3) {
				return A2(
					elm_explorations$test$Expect$equal,
					'22',
					author$project$FizzBuzz$fizzBuzz(22));
			}),
			A2(
			elm_explorations$test$Test$test,
			'handles upper range',
			function (_n4) {
				return A2(
					elm_explorations$test$Expect$equal,
					'Buzz',
					author$project$FizzBuzz$fizzBuzz(100));
			}),
			A2(
			elm_explorations$test$Test$test,
			'handles lower range',
			function (_n5) {
				return A2(
					elm_explorations$test$Expect$equal,
					'1',
					author$project$FizzBuzz$fizzBuzz(1));
			})
		]));
...
var author$project$Test$Generated$Main638904473$main = A2(
	author$project$Test$Runner$Node$run,
	{
		paths: _List_fromArray(
			['/Users/sonarqube/Documents/intellij-work/untitled1/tests/Example.elm']),
		processes: 8,
		report: author$project$Test$Reporter$Reporter$ConsoleReport(author$project$Console$Text$UseColor),
		runs: elm$core$Maybe$Nothing,
		seed: 159876047308593
	},
...
_Platform_export({'Test':{'Generated':{'Main638904473':{'init':author$project$Test$Generated$Main638904473$main(elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
var pipeFilename = "/tmp/elm_test-41094.sock";
